 ...
 * @author Smarty
 */
public class Endingnewbeimode extends javax.swing.JFrame {

    /**
     * Creates new form Ending
     */
    public Endingnewbeimode() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Endingnewbeimode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Endingnewbeimode().setVisible(true);
            }
        });
    }
