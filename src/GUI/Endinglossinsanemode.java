 ...
 * @author Smarty
 */
public class Endinglossinsanemode extends javax.swing.JFrame {

    /**
     * Creates new form Endinglossinsanemode
     */
    public Endinglossinsanemode() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Endinglossinsanemode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Endinglossinsanemode().setVisible(true);
            }
        });
    }
