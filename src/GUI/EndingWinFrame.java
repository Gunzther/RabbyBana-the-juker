 ...
 * @author Smarty
 */
public class Endingcasualmode extends javax.swing.JFrame {

    /**
     * Creates new form Endingcasualmode
     */
    public Endingcasualmode() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Endingcasualmode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Endingcasualmode().setVisible(true);
            }
        });
    }
