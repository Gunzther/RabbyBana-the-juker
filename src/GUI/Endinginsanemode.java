 ...
 * @author Smarty
 */
public class Endinginsanemode extends javax.swing.JFrame {

    /**
     * Creates new form Endinginsanemode
     */
    public Endinginsanemode() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setFont(new java.awt.Font("VitaminTabletE", 0, 36)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Endinginsanemode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Endinginsanemode().setVisible(true);
            }
        });
    }
