...
public class Level {
	...
	public int[] tileColor = { 0xFF00FF00, 0xFF00FF01, 0xFF00FF02, 0xFF00FF03, 0xFF00FF04, 0xFF00FF05, 0xFF00FF06,
			0xFF00FF07, 0xFF00FF08, 0xFF00FF09, 0xFF00FF10, 0xFF00FF11 };
	...
	public void render(Graphics g) {
		...
		if (secTime >= 60 * 1 && secTime <= 60 * 2)
			sec.render(g, gameTime / 60);
		...
		if (gameTime >= 60 * 60) {
			min.render(g, 5);
			OnePlayerNewbieMode.Game.resultCS.setResult(2);
		}
